...
import (
	...
	//"github.com/johnnyeven/bot-sdk-go/bot/directive/video_player"
...
func main() {
	...
	bot.AddIntentHandler(
		"test.inquiry888", func(this *dueros.Bot, request *model.IntentRequest) {
	...
	bot.OnLaunchRequest(
		func(this *dueros.Bot, request *model.LaunchRequest) {
